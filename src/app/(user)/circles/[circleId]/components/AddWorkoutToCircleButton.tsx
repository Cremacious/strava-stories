...
const AddWorkoutToCircleButton = ({ circleId }: { circleId: string }) => {
  const workoutTypes = [
    'Running',
    'Cycling',
    'Strength Training',
  ...
  const { addWorkoutToCircle, isLoading, error, clearError } = useCircleStore();
  ...
  const handleAddWorkout = async () => {
    ...
    await addWorkoutToCircle(workoutData, circleId);
...
export default AddWorkoutToCircleButton;
