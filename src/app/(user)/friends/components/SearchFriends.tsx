...
import { Search, UserPlus, Mail, User, Loader2 } from 'lucide-react';
        ...
        <CardContent className="p-4">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-[#2a2a2a] border-red-700/50 text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500"
            />
          </div>
        </CardContent>
      </Card>
